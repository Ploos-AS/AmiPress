...
#define CP1250_UNDEFINED 0xffffU

static const unsigned short windows1250_to_unicode[128] = {
    0x20ac,CP1250_UNDEFINED,0x201a,CP1250_UNDEFINED,0x201e,0x2026,0x2020,0x2021,
    CP1250_UNDEFINED,0x2030,0x0160,0x2039,0x015a,0x0164,0x017d,0x0179,
    CP1250_UNDEFINED,0x2018,0x2019,0x201c,0x201d,0x2022,0x2013,0x2014,
    CP1250_UNDEFINED,0x2122,0x0161,0x203a,0x015b,0x0165,0x017e,0x017a,
...
int amipress_decode_byte(enum amipress_encoding encoding, unsigned char input, unsigned long *codepoint)
{
    ...
    if (encoding == AMIPRESS_ENCODING_WINDOWS_1250) {
        mapped = windows1250_to_unicode[input - 0x80U];
        if (mapped == CP1250_UNDEFINED) return AMIPRESS_TEXT_ERR_UNMAPPABLE;
        *codepoint = (unsigned long)mapped;
